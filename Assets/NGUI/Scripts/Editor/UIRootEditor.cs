...
public class UIRootEditor : Editor
{
	public override void OnInspectorGUI ()
	{
		...
		else
		{
			...
			NGUIEditorTools.SetLabelWidth(110f);
			GUILayout.EndHorizontal();
			NGUIEditorTools.DrawProperty("Notch Height", serializedObject, "notchHeight", GUILayout.Width(160f));
			NGUIEditorTools.SetLabelWidth(26f);
			NGUIEditorTools.DrawProperty("Safe Area Height", serializedObject, "safeAreaHeight", GUILayout.Width(160f));
			NGUIEditorTools.SetLabelWidth(26f);
			if (fitHeight)
			{
				if (fitWidth)

    ...
    protected override bool ShouldDrawProperties()
    {
        ...
        EditorGUI.BeginDisabledGroup(!isValid);
        {
            ...
            EditorGUI.BeginDisabledGroup(!sp.hasMultipleDifferentValues && !sp.boolValue);
            {
                ...
                if (mLabel.effectStyle == UILabel.Effect.Outline_Shadow || mLabel.effectStyle == UILabel.Effect.Outline_Shadow2)
                {
                    GUILayout.BeginHorizontal();
                    {
                        GUILayout.Label(" ", GUILayout.Width(56f));
                        NGUIEditorTools.SetLabelWidth(20f);
                        NGUIEditorTools.DrawProperty("X", serializedObject, "mEffectDistance2.x",
                                                     GUILayout.MinWidth(40f));
                        NGUIEditorTools.DrawProperty("Y", serializedObject, "mEffectDistance2.y",
                                                     GUILayout.MinWidth(40f));
                        NGUIEditorTools.DrawPadding();
                        NGUIEditorTools.SetLabelWidth(80f);
                        NGUIEditorTools.DrawProperty("", serializedObject, "mEffectColor2", GUILayout.MinWidth(10f));
                    }
                    GUILayout.EndHorizontal();
                }

...
public class UIRoot : MonoBehaviour
{
	...
	public static int IPHONE_X_OFFSET_LEFT;
	public static int IPHONE_X_OFFSET_RIGHT;
	public static int IPHONE_X_OFFSET_TOP;
	public static int IPHONE_X_OFFSET_BOTTOM;
	...
	protected virtual void Start()
	{
		...
		{
			Debug.LogWarning(
				"UIRoot should not be active at the same time as UIOrthoCamera. Disabling UIOrthoCamera.", oc);
		...
		var dHeight = (Screen.height - Screen.safeArea.height);
		var top = dHeight - Screen.safeArea.position.y;
		var bottom = dHeight - top;
		var dWidth = (Screen.width - Screen.safeArea.width);
		var left = (dWidth - Screen.safeArea.position.x);
		var right = dWidth - left;


		IPHONE_X_OFFSET_LEFT = Mathf.FloorToInt(left / Screen.height * manualHeight);
		IPHONE_X_OFFSET_RIGHT = Mathf.FloorToInt(-right / Screen.height * manualHeight);
		IPHONE_X_OFFSET_TOP = Mathf.FloorToInt(-top / Screen.height * manualHeight);
		IPHONE_X_OFFSET_BOTTOM = Mathf.FloorToInt((bottom) / Screen.height * manualHeight);
	}

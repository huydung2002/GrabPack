...
{
    [System.NonSerialized] static public AudioListener mListener;
    ...
    static bool mLoadedMusic = false;
    static float mMusicVolume = 1f;
    ...
    static public bool JoystickEnable
    {
        get
        {
            return PlayerPrefs.GetInt("Joystick", 0) > 0;
        }
        set
        {
            PlayerPrefs.SetInt("Joystick", value ? 1 : 0);
        }
    }
    /// <summary>
    ...
    static public UIPanel CreateUI(Transform trans, bool advanced3D, int layer)
    {
        ...
        if (root == null)
        {
            Debug.Log("Create UI Root - Hiker Debug");

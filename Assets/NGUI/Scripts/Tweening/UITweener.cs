...
public abstract class UITweener : MonoBehaviour
{
	...
	protected void Update () { if (!useFixedUpdate && !useLateUpdate) DoUpdate(); }
	protected void FixedUpdate () { if (useFixedUpdate && !useLateUpdate) DoUpdate(); }
	protected void LateUpdate() { if (!useFixedUpdate && useLateUpdate) DoUpdate(); }
